    ...
    return (
        <header className={`fixed w-full z-[9999] transition-all duration-300 ${isScrolled ? 'bg-white shadow-md py-4' : 'bg-transparent py-6'}`}>
            <div className="container mx-auto px-4 flex justify-between items-center">
                {/* Logo */}
                <Link to="/" className="flex items-center gap-2 text-2xl font-bold text-yum-primary cursor-pointer" onClick={() => window.scrollTo(0, 0)}>
                    <img src="/assets/yumyum_logo.png" alt="YumYum Logo" className="h-10 w-auto" />
                    <span>YumYum</span>
                </Link>
