...
import { FiHome, FiGrid, FiBarChart2, FiUsers, FiCpu, FiSettings, FiLogOut } from 'react-icons/fi' // Assuming react-icons is available or I'll stick to SVGs if unsure, lets stick to SVGs to be safe but style them better.
...
const DashboardSidebar = ({ activeModule, onModuleChange, isOpen, onClose }) => {
    ...
    const modules = [
        ...
        { id: 'promos', label: 'Promos', icon: 'M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z' },
        { id: 'subscription', label: 'Subscription', icon: 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.382-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z' },
                    ...
                    <nav className="flex-1 flex flex-col gap-6 w-full px-4">
                        {modules.map((module) => (
                            ...
                            >
                                ...
                                {/* Hover Tooltip */}
                                <span className="absolute left-full ml-4 px-3 py-1 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap shadow-xl">
                                    {module.label}
                                </span>
