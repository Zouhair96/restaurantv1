...
const AdminHeader = ({ activeSection, onSectionChange, toggleMobileMenu, onAddMenuClick }) => {
    const { t } = useLanguage();
        ...
        <header className="h-16 sm:h-20 px-4 sm:px-6 md:px-8 flex items-center justify-between border-b border-gray-100 dark:border-white/5 bg-white/50 dark:bg-black/20 backdrop-blur-xl sticky top-0 z-40 transition-colors">
            ...
            <div className="flex items-center gap-3">
                ...
                <button
                    ...
                    className="bg-[#1C1C1E] dark:bg-[#6359E9] hover:opacity-90 text-white px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 rounded-xl text-[11px] sm:text-[12px] font-black shadow-lg shadow-indigo-200/20 dark:shadow-indigo-500/20 transition-all flex items-center gap-2"
                >
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 4v16m8-8H4" />
                    </svg>
                    <span className="hidden sm:inline">Add New Menu</span>
