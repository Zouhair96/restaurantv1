...
const ManageMenuTestemplate = ({ isAdminView = false }) => {
    const { user: currentUser } = useAuth();
    const navigate = useNavigate();
    const { templateKey: urlTemplateKey } = useParams();
    const templateKey = urlTemplateKey || 'testemplate';

    const [items, setItems] = useState([]);
    const [template, setTemplate] = useState(null);
    const [menuConfig, setMenuConfig] = useState({
        restaurantName: '',
        themeColor: '#22c55e', // Default green for this template
        logoImage: null,
        useLogo: false,
        showWelcomePromo: true,
        welcomePromoText: "Welcome! Enjoy fresh and healthy food delivered to your door.",
        loadingDuration: 3,
        promoDuration: 5
    });
            ...
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
                <div className="space-y-1">
                    <button
                        ...
                        className="flex items-center gap-2 text-gray-400 hover:text-green-600 mb-4 font-black transition-all uppercase text-[10px] tracking-widest group"
                    >
                        <HiArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" /> Back to Dashboard
                    </button>
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-green-500/10 flex items-center justify-center text-3xl border border-green-500/20 shadow-inner">
                            {template?.icon || '🥗'}
                        </div>
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                <span className="px-2 py-0.5 rounded-full bg-green-500 text-white text-[9px] font-black uppercase tracking-widest">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    {isAdminView ? (
                        <a
                            ...
                            className="p-4 bg-green-600 text-white font-black rounded-2xl shadow-lg shadow-green-600/20 hover:bg-green-500 transition-all flex items-center justify-center gap-2"
                        >
                    ...
                    <button
                        ...
                        className="p-4 bg-green-50 dark:bg-white/10 text-green-600 dark:text-white font-black rounded-2xl border-2 border-green-200 shadow-md hover:border-green-500 hover:bg-white transition-all active:rotate-45"
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-8">
                <div className="flex-1 relative">
                    <input
                        ...
                        className="w-full pl-6 pr-12 py-4 rounded-2xl bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 text-gray-800 dark:text-white font-bold focus:ring-2 focus:ring-green-500 outline-none transition-all shadow-sm"
                    />
                </div>
                        ...
                        >
                            ...
                            <div className="relative h-48 overflow-hidden">
                                {item.image_url ? (
                                    ...
                                    <div className="w-full h-full bg-green-50 dark:bg-green-500/5 flex items-center justify-center text-green-300">
                                ...
                                <div className="absolute bottom-4 right-4 bg-green-600 text-white font-black px-4 py-1.5 rounded-xl shadow-lg border border-white/20 text-sm">
                            ...
                            {/* Content */}
                            <div className="p-6">
                                <h3 className="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tight mb-2 group-hover:text-green-600 transition-colors">
                                    {item.name}
                                </h3>
                                ...
                                <div className="mt-6 flex items-center gap-2">
                                    <button
                                        ...
                                        className="flex-1 flex items-center justify-center gap-2 py-3 bg-gray-50 dark:bg-white/5 hover:bg-green-600 hover:text-white text-gray-600 dark:text-gray-300 font-black rounded-xl text-[10px] uppercase tracking-widest transition-all"
                                    >
                    ...
                    <div className="bg-white dark:bg-[#1a1c23] rounded-[2.5rem] shadow-2xl w-full max-w-lg overflow-hidden border border-white dark:border-white/10">
                        ...
                        <div className="p-8 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-5 py-4 rounded-2xl border border-gray-100 dark:border-white/10 bg-white dark:bg-[#24262d] text-gray-900 dark:text-white font-bold focus:ring-2 focus:ring-green-500 outline-none transition-all"
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-5 py-4 rounded-2xl border border-gray-100 dark:border-white/10 bg-white dark:bg-[#24262d] text-gray-900 dark:text-white font-mono font-bold focus:ring-2 focus:ring-green-500 outline-none transition-all"
                                    />
                                </div>
                                <div>
                                    ...
                                    <select
                                        ...
                                        className={`w-full px-5 py-4 rounded-2xl border border-gray-100 dark:border-white/10 bg-white dark:bg-[#24262d] text-gray-900 dark:text-white font-bold focus:ring-2 focus:ring-green-500 outline-none transition-all ${!isAdminView ? 'opacity-70' : ''}`}
                                    >
                            ...
                            <div>
                                ...
                                <div
                                    className="relative w-full h-40 border-2 border-dashed border-gray-100 dark:border-white/10 rounded-3xl flex flex-col items-center justify-center text-gray-400 hover:border-green-500 hover:bg-green-50/30 transition-all cursor-pointer overflow-hidden group"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-5 py-4 rounded-2xl border border-gray-100 dark:border-white/10 bg-white dark:bg-[#24262d] text-gray-900 dark:text-white font-medium italic focus:ring-2 focus:ring-green-500 outline-none transition-all resize-none"
                        ...
                        <div className="p-8 space-y-8 max-h-[60vh] overflow-y-auto no-scrollbar">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-4 rounded-2xl border border-gray-100 dark:border-white/10 bg-white dark:bg-[#24262d] text-gray-900 dark:text-white font-bold outline-none ring-green-500 focus:ring-2"
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between p-5 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-100 dark:border-white/5">
                                ...
                                <button
                                    ...
                                    className={`w-14 h-8 rounded-full transition-all relative ${menuConfig.useLogo ? 'bg-green-600' : 'bg-gray-200 dark:bg-gray-700'}`}
                                >
                            ...
                            <div className="pt-4 border-t border-gray-100 dark:border-white/5 mt-4">
                                <h4 className="text-[10px] font-black text-green-500 uppercase tracking-[0.2em] mb-6">Welcome Promotion</h4>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center justify-between p-5 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-100 dark:border-white/5">
                                        ...
                                        <button
                                            ...
                                            className={`w-14 h-8 rounded-full transition-all relative ${menuConfig.showWelcomePromo ? 'bg-green-600' : 'bg-gray-200 dark:bg-gray-700'}`}
                                        >
...
export default ManageMenuTestemplate;
