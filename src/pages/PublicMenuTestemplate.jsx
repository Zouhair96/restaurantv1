...
const PublicMenuTestemplate = ({ restaurantName: propRestaurantName }) => {
    ...
    return (
        <div className="flex flex-col h-screen bg-gray-50 font-sans text-gray-800 relative overflow-hidden" style={{ '--theme-color': config.themeColor }}>
                                            ...
                                            <div className={`relative h-full px-8 flex items-center z-20 ${promo.discountPosition === 'right' ? 'flex-row' : 'flex-row-reverse'} justify-between gap-6 w-full`}>
                                                ...
                                                {promo.showDiscountOnBanner !== false && (
                                                    <motion.div
                                                        ...
                                                        className="shrink-0 flex flex-col items-center justify-center p-3 md:p-4"
                                                    >
            ...
            <PublicMenuSidebar isOpen={showAuthSidebar} onClose={() => setShowAuthSidebar(false)} restaurantName={restaurantName} displayName={config.restaurantName} themeColor={config.themeColor} socialMedia={config.socialMedia} loyaltyInfo={loyaltyInfo} />
            <Checkout
